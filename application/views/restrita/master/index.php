          	            ...
          	            <tbody>
          	              <?php foreach ($masters as $master): ?>
          	              	<tr>
          	              		...
          	              		<td><?php echo ($master->categoria_pai_ativa == 1 ? 
                                '<span class="badge badge-success badge-shadow">Ativo</span>' : '<span class="badge badge-danger badge-shadow">Inativo</span>'); ?></td>
                            <td>
                              <a data-toggle="tooltip" data-placement="top" title="Editar usuário" href="<?php echo base_url('restrita/' . $this->router->fetch_class() . '/core/' . $master->categoria_pai_id); ?>" class="btn btn-sm btn-icon btn-primary badge-shadow mr-2">
                                <i class="far fa-edit"></i>&nbsp;&nbsp;Editar</a>

                              <a data-toggle="tooltip" data-placement="top" title="Excluir usuário" href="<?php echo base_url('restrita/' . $this->router->fetch_class() . '/delete/' . $master->categoria_pai_id); ?>" 
