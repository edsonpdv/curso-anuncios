                ...
                <div class="col-lg-3 col-md-12 col-xs-12 page-sidebar">
                    <aside>
                        ...
                        <div class="widget">
                            ...
                            <div class="add-box">
                                <img class="img-fluid" src="<?php echo base_url('public/web/assets/'); ?>img/img1.jpg" alt="">
                            </div>
                        </div>
                    </aside>
                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="featured-box">
                                            <figure>
                                                ...
                                                <a href="#"><img class="img-fluid" src="<?php echo base_url('public/web/assets/'); ?>img/featured/img-1.jpg"
                                                        alt=""></a>
                                            </figure>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="featured-box">
                                            <figure>
                                                ...
                                                <a href="#"><img class="img-fluid" src="<?php echo base_url('public/web/assets/'); ?>img/featured/img-2.jpg"
                                                        alt=""></a>
                                            </figure>
                                            <div class="feature-content">
                                                <div class="product">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="featured-box">
                                            <figure>
                                                ...
                                                <a href="#"><img class="img-fluid" src="<?php echo base_url('public/web/assets/'); ?>img/featured/img-3.jpg"
                                                        alt=""></a>
                                            </figure>
                                            <div class="feature-content">
                                                <div class="product">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="featured-box">
                                            <figure>
                                                ...
                                                <a href="#"><img class="img-fluid" src="<?php echo base_url('public/web/assets/'); ?>img/featured/img-4.jpg"
                                                        alt=""></a>
                                            </figure>
                                            <div class="feature-content">
                                                <div class="product">
